...
import type { Font, Theme } from "@typebot.io/theme/schemas";
    ...
    <>
      ...
      <Show when={initialChatReply()} keyed>
        {(initialChatReply) => (
          <BotContent
            class={props.class}
            onHeaderClose={props.onHeaderClose}
            initialChatReply={{
              ...initialChatReply,
              typebot: {
...
const BotContent = (props: BotContentProps) => {
  ...
  const [latestTheme, setLatestTheme] = createSignal<Theme>(
    mergeThemes(
  ...
  return (
    <BotContainerContext.Provider value={() => botContainer}>
      ...
      >
        ...
        <Show
          when={props.initialChatReply.typebot.theme.chat?.header?.isEnabled}
        >
          <ChatHeader
            header={latestTheme().chat!.header!}
            contact={latestTheme().chat?.contact}
            avatarUrl={latestTheme().chat?.hostAvatar?.url}
