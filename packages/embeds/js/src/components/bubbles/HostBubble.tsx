...
import { LinkBubble } from "../../features/blocks/bubbles/link/components/LinkBubble";
...
export const HostBubble = (props: Props) => (
  <Switch>
    ...
    <Match when={props.message.type === BubbleBlockType.LINK}>
      <LinkBubble
        content={props.message.content as LinkBubbleBlock["content"]}
        onTransitionEnd={props.onTransitionEnd}
      />
    </Match>
  </Switch>
