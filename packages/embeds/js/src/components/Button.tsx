...
export const buttonVariants = cva(
  "font-semibold focus:outline-none filter hover:brightness-90 active:brightness-75 disabled:opacity-50 disabled:cursor-not-allowed disabled:brightness-100 flex items-center justify-center shrink-0 transition-[filter] duration-200 cursor-pointer",
  {
    variants: {
      variant: {
        primary:
        ...
        outline:
          "typebot-button bg-button-text text-button-bg border-button-bg rounded-button border-2 blur-button shadow-button",
        secondary:
