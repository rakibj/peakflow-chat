...
export const Buttons = (props: Props) => {
  ...
  const submitFreeText = (e: Event) => {
    ...
    if (!value) return;
    props.onSubmit({ type: "text", value, metadata: { isFreeText: true } });
  };
          ...
          {(item, index) => (
            <span class="relative">
              <Button
                ...
                class="w-full h-full"
                variant={
                  props.options?.buttonStyle === "outline"
                    ? "outline"
                    : "primary"
                }
              >
