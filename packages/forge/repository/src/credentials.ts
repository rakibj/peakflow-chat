...
import { shopifyBlock } from "@typebot.io/shopify-block";
import { shopifyCredentialsSchema } from "@typebot.io/shopify-block/schemas";
...
export const forgedCredentialsSchemas = {
  ...
  [shopifyBlock.id]: shopifyCredentialsSchema,
};
