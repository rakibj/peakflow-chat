...
const contactBusinessHoursSchema = z.object({
  timeZone: z.string(),
...
const contactSchema = z.object({
  ...
  whatsAppIconUrl: z.string().optional(),
  callLabel: z.string().optional(),
  callIconUrl: z.string().optional(),
  locations: z.array(contactLocationSchema).optional(),
  businessHours: contactBusinessHoursSchema,
  availableMessage: z.string().optional(),
...
export const dynamicThemeSchema = z.object({
  ...
  availableMessage: z.string().optional(),
  unavailableMessage: z.string().optional(),
  headerStatus: z.string().optional(),
