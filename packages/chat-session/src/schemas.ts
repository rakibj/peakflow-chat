...
const sessionStateSchemaV3 = sessionStateSchemaV2
  ...
  .extend({
    ...
    conversationHistory: z
      ...
      .optional()
      .describe(
        "Global transcript of bot messages and human replies, used by the AI Interruption event to decide whether the conversation needs to be redirected",
      ),
  });
