...
import { LinkBubbleContent } from "@/features/blocks/bubbles/link/components/LinkBubbleContent";
...
import { JsonJoinNodeContent } from "@/features/blocks/logic/jsonJoin/components/JsonJoinNodeContent";
import { JsonRemapNodeContent } from "@/features/blocks/logic/jsonRemap/components/JsonRemapNodeContent";
...
export const BlockNodeContent = ({
  ...
  switch (block.type) {
    ...
    case BubbleBlockType.LINK: {
      return <LinkBubbleContent block={block} />;
    }
    ...
    case LogicBlockType.JSON_REMAP:
      return <JsonRemapNodeContent options={block.options} />;
    case LogicBlockType.JSON_JOIN:
      return <JsonJoinNodeContent options={block.options} />;
