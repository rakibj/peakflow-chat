        ...
        render={(props) => (
          <ContextMenu.Root onOpenChange={setIsContextMenuOpened}>
            <ContextMenu.Trigger>
              ...
              <div
                className="flex relative w-full prevent-group-drag group"
                {...props}
              ...
              >
                ...
                >
                  ...
                  {!isReadOnly && (
                    ...
                    <button
                      className={cx(
                        "absolute top-1 right-1 p-0.5 rounded text-gray-9 hover:text-gray-12 transition-opacity z-10",
                        block.disabled
                          ? "opacity-100"
                    ...
                    >
                      {block.disabled ? (
                        <ViewOffSlashIcon className="w-3.5 h-3.5" />
                      ) : (
