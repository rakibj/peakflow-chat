...
import { LinkBubbleSettings } from "@/features/blocks/bubbles/link/components/LinkBubbleSettings";
...
export const MediaBubbleContent = ({
  ...
  switch (block.type) {
    ...
    case BubbleBlockType.LINK: {
      return (
        <LinkBubbleSettings block={block} onContentChange={onContentChange} />
      );
    }
  }
};
