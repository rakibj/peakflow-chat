...
import { LinkBubbleIcon } from "@/features/blocks/bubbles/link/components/LinkBubbleIcon";
...
import { JsonJoinIcon } from "@/features/blocks/logic/jsonJoin/components/JsonJoinIcon";
import { JsonRemapIcon } from "@/features/blocks/logic/jsonRemap/components/JsonRemapIcon";
...
export const BlockIcon = ({ type, className }: BlockIconProps): JSX.Element => {
  ...
  switch (type) {
    ...
    case BubbleBlockType.LINK:
      return (
        <LinkBubbleIcon className={cn("text-gray-12 stroke-2", className)} />
      );
    ...
    case LogicBlockType.JSON_REMAP:
      return (
        <JsonRemapIcon className={cn("text-purple-9 stroke-2", className)} />
      );
    case LogicBlockType.JSON_JOIN:
      return (
        <JsonJoinIcon className={cn("text-purple-9 stroke-2", className)} />
      );
